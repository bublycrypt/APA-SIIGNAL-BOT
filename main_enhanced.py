"""
APA Signal Bot – Main entry point (enhanced)
"""
...
from core.live_data import LiveDataFetcher, fetch_binance_spot, fetch_from_csv
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Run signal check on local data
  python main_enhanced.py signal --ltf data/sample_ltf_m15.csv --htf data/sample_htf_h1.csv

  # Run backtest with local data
  python main_enhanced.py backtest --ltf data/sample_ltf_m15.csv --htf data/sample_htf_h1.csv

  # Fetch live Binance data and backtest
  python main_enhanced.py backtest --exchange binance --symbol BTC/USDT --ltf-tf 1h --htf-tf 4h

  # Live monitoring on crypto (prints signals as they occur)
  python main_enhanced.py live --exchange binance --symbol ETH/USDT --timeframe 1h
        """
    )

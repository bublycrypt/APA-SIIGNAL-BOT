"""
APA Signal Bot – Main entry point
---------------------------------
Examples:
  ...
  # Run signal check
  python main.py --mode signal --ltf data/sample_ltf_m15.csv --htf data/sample_htf_h1.csv

  # Run backtest
  python main.py --mode backtest --ltf data/sample_ltf_m15.csv --htf data/sample_htf_h1.csv --min-score 0.55 --rr 2.0
"""
...
from utils.telegram import send_telegram_message, format_signal_message
